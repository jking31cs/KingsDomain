...
public class FourPointExample extends PApplet {
	...
	public void setup() {
		...
		mainShape = new ConvexShape(p1,p2,p3,p4);
	}
	...
	public void mouseDragged() {
		if (changeP1) {
			mainShape = new ConvexShape(new Point(mouseX, mouseY), mainShape.points.get(1), mainShape.points.get(2), mainShape.points.get(3));
		}
		if (changeP2) {
			mainShape = new ConvexShape(mainShape.points.get(0), new Point(mouseX, mouseY), mainShape.points.get(2), mainShape.points.get(3));
		}
		if (changeP3) {
			mainShape = new ConvexShape(mainShape.points.get(0), mainShape.points.get(1), new Point(mouseX, mouseY), mainShape.points.get(3));
		}
		if (changeP4) {
			mainShape = new ConvexShape(mainShape.points.get(0), mainShape.points.get(1), mainShape.points.get(2), new Point(mouseX, mouseY));
		}
	}
